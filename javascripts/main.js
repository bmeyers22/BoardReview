...
function selectExamOptions(event) {
    ...
    var examOptionsHtml = "<div id='examOptions' style='display:none'>" +
        ...
        "<div style='color:#222; padding:10px;display:inline-block;text-align:left;padding-right:100px'>" +
        ...
        api.get({
            ...
            .done(function(data) {
                ...
                var output = "<div id='questionCountResults'>Available questions: " + n_q_available + "<br> The maximum number of questions you can select is <span id='countShow'>" + window.exam.maxQ + "</span>.<br /> " +
                    "Choose the number of questions you would like to answer:<input type='text' id='numQues' /><br /><br />" + hasSeenCheckbox +
    ...
    if (obj.isParsed === 0) {
        ...
        if ((window.exam.examQuestions[window.exam.currentQuestion].creditReceived == true & window.exam.examType === "Tutor") || window.exam.examFinished == true) {
            ...
            if (fancyExp) {
                ...
                // Add the wiki page
                var wikipage_div = "<div id='wikipage_div'> <h1>Question ID</h1>" + window.exam.examQuestions[window.exam.currentQuestion].PageName + "</div><br>";
                $("#explanationSpace").append(wikipage_div);
                $("#explanationSpace").append("<br /><br />Discuss this question <a href='http://www.wikidoc.org/index.php/Talk:" + window.exam.examQuestions[window.exam.currentQuestion].PageName + "'>Here</a>");
            }
...
function endExam(event) {
    ...
    api.get({
        action: 'exams',
        subAction: 'save',
        exam: JSON.stringify(window.exam),
        format: 'json'
    })
        .done(function(data) {
            console.log(data);
